...
class VirtualScreen(object):
    ...
    def init_real_screen(self, real_screen_dimensions, display_mode):
        ...
        self.real_screen = pygame.display.set_mode(real_screen_dimensions, display_mode)

    def init_virtual_screen(self, screen_dimensions, scale):

        self.screen = ScaledScreen(screen_dimensions, self.real_screen, scale, depth=32)

    def create_screen(self, real_screen_dimensions, display_mode, screen_dimensions, scale):
